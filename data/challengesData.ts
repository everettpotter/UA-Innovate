...
export const TIERS: Tier[] = [
  { name: 'Bronze',   minXP: 0,    color: '#CD7F32', badge: 'ribbon-outline' },
  { name: 'Silver',   minXP: 500,  color: '#9E9E9E', badge: 'ribbon-outline' },
  { name: 'Gold',     minXP: 1000, color: '#FFB300', badge: 'ribbon-outline' },
  { name: 'Platinum', minXP: 2000, color: '#0069aa', badge: 'star-outline' },
  { name: 'Diamond',  minXP: 4000, color: '#7C4DFF', badge: 'trophy-outline' },
];
